...
<head>
    ...
    <!-- Title -->
    <title>500 - Kesalahan Server | SAPA MS ACEH</title>
            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-xl-6 error-page">
                    <div class="error-inner text-center">
                        <div class="dz-error text-success" data-text="500" style="color: #0b6e39 !important;">500</div>
                        <h2 class="error-head"><i class="fa fa-triangle-exclamation text-danger me-2"></i> Terjadi Kesalahan Internal Server!</h2>
                        <p class="text-muted fs-16">Sistem sedang mengalami kendala teknis internal. Tim teknis sedang berupaya memperbaikinya.</p>
                        <div>
