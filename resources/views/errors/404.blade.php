...
<head>
    <!-- Title -->
    <title>404 - Halaman Tidak Ditemukan | SAPA MS ACEH</title>
            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-xl-6 error-page">
                    <div class="error-inner text-center">
                        <div class="dz-error text-success" data-text="404" style="color: #0b6e39 !important;">404</div>
                        <h2 class="error-head"><i class="fa fa-exclamation-triangle text-warning me-2"></i> Halaman yang Anda cari tidak ditemukan!</h2>
                        <p class="text-muted">Anda mungkin salah mengetik alamat URL atau halaman telah dipindahkan.</p>
                        <div>
